	...
	public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
		try {
			...
			if (action.equals("startActivity")) {
				...
				callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, intentAction));
				return true;
				...
				if (i.hasExtra(extraName)) {
					...
					// i.getStringExtra(extraName));
					callbackContext
							.sendPluginResult(new PluginResult(PluginResult.Status.OK, i.getStringExtra(extraName)));
					return true;
				} else {
				...
				// save reference to the callback; will be called on "new
				// intent" events
				...
				result.setKeepCallback(true); // re-use the callback on intent
												// events
